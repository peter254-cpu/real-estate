...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      setLoading(true)
      const res = await fetch('https://realestates-apllication.onrender.com/api/auth/signup',{
        method: "POST",
        headers: {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        <input type='text' placeholder='Username' className='border p-3 rounded-lg' id='username' onChange={handlehange}  />
      ...
      <div className='flex gap-2 mt-5'><p>Already have an account..?</p><Link to={"/sign-in"}><span className='text-blue-700'>Login</span></Link> </div>
